...
const formSchema = z.object({
  vendor: z.string().min(1, "供应商名称不能为空"),
  integrator: z.string().min(1, "集成（代理）商名称不能为空"),
  endCustomer: z.string().min(1, "终端客户名称不能为空"),
...
export default function ProcurementForm() {
  ...
  if (submitSuccess) {
    return (
      <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-none lg:shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]">
        <div className="text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-6 text-left max-w-2xl mx-auto">
            ...
            <p className="text-gray-700 leading-relaxed mt-2">
              ...
              ，请您通过云雀台 APP 向客户服务中心提交工单编号查询业务进度与结果
            </p>
            <p className="text-gray-700 leading-relaxed mt-2">
  ...
  return (
    <div className="max-w-4xl mx-auto my-12 p-6 bg-white rounded-lg shadow-none lg:shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">采购申请表单</h2>
